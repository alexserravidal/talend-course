...
package local_project.c4_jobc3usingexistingconnection_0_1;
...
/**
 * Job: C4_JobC3UsingExistingConnection Purpose: <br>
 * Description: Igual que C3, pero 

 A) Establece y cierra las conexiones a BD con prejobs y postjobs, respectivamente. Configura los componentes para que usen conexiones ya existentes. 

 B) Realiza commit o rollback para C2 dependiendo de si el insert ha ido bien o mal. <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class C4_JobC3UsingExistingConnection implements TalendJob {
	...
	private final String jobName = "C4_JobC3UsingExistingConnection";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					C4_JobC3UsingExistingConnection.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(C4_JobC3UsingExistingConnection.this,
	...
	public static class row3Struct implements
		...
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_C4_JobC3UsingExistingConnection = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_C4_JobC3UsingExistingConnection = new byte[0];
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LOCAL_PROJECT_C4_JobC3UsingExistingConnection) {
	...
	public void tDBInput_3Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String tableName_tDBOutput_3 = "migration_destiny";
					...
					while (rs_tDBInput_3.next()) {
						...
						if (colQtyInRs_tDBInput_3 < 1) {
							...
							if (rs_tDBInput_3.getObject(1) != null) {
								row3.col1 = rs_tDBInput_3.getInt(1);
							} else {
						...
						if (colQtyInRs_tDBInput_3 < 2) {
							...
							if (rs_tDBInput_3.getObject(2) != null) {
								row3.col2 = rs_tDBInput_3.getInt(2);
							} else {
								throw new RuntimeException(
										"Null value in non-Nullable column");
							}
						...
						if (colQtyInRs_tDBInput_3 < 3) {
							...
							if (rs_tDBInput_3.getObject(3) != null) {
								row3.col3 = rs_tDBInput_3.getInt(3);
							} else {
								throw new RuntimeException(
										"Null value in non-Nullable column");
							}
						...
						if (colQtyInRs_tDBInput_3 < 4) {
							...
							if (rs_tDBInput_3.getObject(4) != null) {
								row3.col4 = rs_tDBInput_3.getInt(4);
							} else {
								throw new RuntimeException(
										"Null value in non-Nullable column");
							}
						...
						pstmt_tDBOutput_3.setInt(1, row3.col1);

						pstmt_tDBOutput_3.setInt(2, row3.col2);

						pstmt_tDBOutput_3.setInt(3, row3.col3);

						pstmt_tDBOutput_3.setInt(4, row3.col4);
			...
			if (resumeEntryMethodName == null || globalResumeTicket) {
				resumeUtil
						.addLog("CHECKPOINT",
								"CONNECTION:SUBJOB_OK:tDBInput_3:OnSubjobOk",
					...
					while (rs_tDBInput_4.next()) {
						...
						if (colQtyInRs_tDBInput_4 < 1) {
							...
							if (rs_tDBInput_4.getObject(1) != null) {
								row1.col1 = rs_tDBInput_4.getInt(1);
							} else {
								throw new RuntimeException(
										"Null value in non-Nullable column");
							}
						...
						if (colQtyInRs_tDBInput_4 < 2) {
							...
							if (rs_tDBInput_4.getObject(2) != null) {
								row1.col2 = rs_tDBInput_4.getInt(2);
							} else {
								throw new RuntimeException(
										"Null value in non-Nullable column");
							}
						...
						if (colQtyInRs_tDBInput_4 < 3) {
							...
							if (rs_tDBInput_4.getObject(3) != null) {
								row1.col3 = rs_tDBInput_4.getInt(3);
							} else {
								throw new RuntimeException(
										"Null value in non-Nullable column");
							}
						...
						if (colQtyInRs_tDBInput_4 < 4) {
							...
							if (rs_tDBInput_4.getObject(4) != null) {
								row1.col4 = rs_tDBInput_4.getInt(4);
							} else {
								throw new RuntimeException(
										"Null value in non-Nullable column");
							}
						...
						Operator_tFilterRow_1 ope_tFilterRow_1 = new Operator_tFilterRow_1(
								"&&");
						ope_tFilterRow_1.matches((row1.col1 == 5),
								"col1==5 failed");
	...
	public void tDBRollback_1Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				java.sql.Connection conn_tDBRollback_1 = (java.sql.Connection) globalMap
						.get("conn_tDBConnection_1");

				if (conn_tDBRollback_1 != null
						&& !conn_tDBRollback_1.isClosed()) {
	...
	public static void main(String[] args) {
		final C4_JobC3UsingExistingConnection C4_JobC3UsingExistingConnectionClass = new C4_JobC3UsingExistingConnection();

		int exitCode = C4_JobC3UsingExistingConnectionClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = C4_JobC3UsingExistingConnection.class
					.getClassLoader().getResourceAsStream(
							"local_project/c4_jobc3usingexistingconnection_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = C4_JobC3UsingExistingConnection.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : C4_JobC3UsingExistingConnection");
		}
...
/************************************************************************************************
 * 95858 characters generated by Talend Open Studio for Data Integration on the
 * 21 de mayo de 2019 11:32:32 CEST
 ************************************************************************************************/
