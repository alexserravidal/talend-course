...
package local_project.c3_subjobsc1c2_0_1;
...
/**
 * Job: C3_SubjobsC1C2 Purpose: <br>
 * Description: Disparador subjobOk que hace que C2 se ejecute cuando C1 haya terminado su ejecución <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class C3_SubjobsC1C2 implements TalendJob {
	...
	private final String jobName = "C3_SubjobsC1C2";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					C3_SubjobsC1C2.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(C3_SubjobsC1C2.this, new Object[] { e,
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				local_project.c1_recreateandmigratetabla1_0_1.C1_RecreateAndMigrateTabla1 childJob_tRunJob_1 = new local_project.c1_recreateandmigratetabla1_0_1.C1_RecreateAndMigrateTabla1();
				// pass DataSources
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				local_project.c2_recreateandmigratetabla1withfilter_0_1.C2_RecreateAndMigrateTabla1WithFilter childJob_tRunJob_2 = new local_project.c2_recreateandmigratetabla1withfilter_0_1.C2_RecreateAndMigrateTabla1WithFilter();
				// pass DataSources
	...
	public static void main(String[] args) {
		final C3_SubjobsC1C2 C3_SubjobsC1C2Class = new C3_SubjobsC1C2();

		int exitCode = C3_SubjobsC1C2Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = C3_SubjobsC1C2.class
					.getClassLoader().getResourceAsStream(
							"local_project/c3_subjobsc1c2_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = C3_SubjobsC1C2.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : C3_SubjobsC1C2");
		}
...
/************************************************************************************************
 * 34213 characters generated by Talend Open Studio for Data Integration on the
 * 21 de mayo de 2019 11:28:12 CEST
 ************************************************************************************************/
