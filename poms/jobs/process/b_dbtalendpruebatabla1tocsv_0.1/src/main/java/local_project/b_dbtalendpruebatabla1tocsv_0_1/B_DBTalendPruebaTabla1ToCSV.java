...
package local_project.b_dbtalendpruebatabla1tocsv_0_1;
...
/**
 * Job: B_DBTalendPruebaTabla1ToCSV Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class B_DBTalendPruebaTabla1ToCSV implements TalendJob {
	...
	private final String jobName = "B_DBTalendPruebaTabla1ToCSV";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					B_DBTalendPruebaTabla1ToCSV.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(B_DBTalendPruebaTabla1ToCSV.this,
	...
	public static class row1Struct implements
		...
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_B_DBTalendPruebaTabla1ToCSV = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_B_DBTalendPruebaTabla1ToCSV = new byte[0];
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LOCAL_PROJECT_B_DBTalendPruebaTabla1ToCSV) {
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				resourceMap.put("nb_line_tFileOutputPositional_1",
						nb_line_tFileOutputPositional_1);

				class PositionUtil_tFileOutputPositional_1 {

					void writeHeader_0(
							String tempStringBtFileOutputPositional_1,
							int tempLengthBtFileOutputPositional_1,
							final java.io.BufferedWriter outtFileOutputPositional_1)
							throws IOException,
							java.io.UnsupportedEncodingException {

						int tempLengthMtFileOutputPositional_1 = 0;
						// get and format output String begin
						tempStringBtFileOutputPositional_1 = "col1";

						tempLengthBtFileOutputPositional_1 = tempStringBtFileOutputPositional_1
								.length();
						...
						if (tempLengthBtFileOutputPositional_1 > 10) {
							...
							resulttFileOutputPositional_1
									.append(tempStringBtFileOutputPositional_1);
							...
							tempStringBtFileOutputPositional_1 = resulttFileOutputPositional_1
									.toString();
						}
						// get and format output String end
						outtFileOutputPositional_1
								.write(tempStringBtFileOutputPositional_1);
						// get and format output String begin
						tempStringBtFileOutputPositional_1 = "col2";
						...
						outtFileOutputPositional_1
								.write(tempStringBtFileOutputPositional_1);
						// get and format output String begin
						tempStringBtFileOutputPositional_1 = "col3";
						...
						outtFileOutputPositional_1
								.write(tempStringBtFileOutputPositional_1);
						// get and format output String begin
						tempStringBtFileOutputPositional_1 = "col4";
					...
					void setValue_0(final row1Struct row1,
							...
							java.io.UnsupportedEncodingException {
						// get and format output String begin
						tempStringMtFileOutputPositional_1 = String
								.valueOf(row1.col1);
				...
				String fileNewName_tFileOutputPositional_1 = "C:/Program Files/TOS_DI-Win32-20181026_1147-V7.1.1/workspace/LOCAL_PROJECT/outputs/dbTalendPruebaTabla1.csv";
				...
				resourceMap.put("createFiletFileOutputPositional_1",
						createFiletFileOutputPositional_1);
				resourceMap.put("isFileGenerated_tFileOutputPositional_1",
						isFileGenerated_tFileOutputPositional_1);
				...
				final java.io.BufferedWriter outtFileOutputPositional_1 = new java.io.BufferedWriter(
						new java.io.OutputStreamWriter(
								new java.io.FileOutputStream(
										fileNewName_tFileOutputPositional_1,
										false), "ISO-8859-15"));
				resourceMap.put("outtFileOutputPositional_1",
						outtFileOutputPositional_1);
				if (createFiletFileOutputPositional_1.length() == 0) {
					...
					positionUtil_tFileOutputPositional_1.writeHeader_0(
							tempStringBtFileOutputPositional_1,
							tempLengthBtFileOutputPositional_1,
							outtFileOutputPositional_1);
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 1) {
							...
							if (rs_tDBInput_1.getObject(1) != null) {
								row1.col1 = rs_tDBInput_1.getInt(1);
							} else {
						...
						if (colQtyInRs_tDBInput_1 < 2) {
							...
							if (rs_tDBInput_1.getObject(2) != null) {
								row1.col2 = rs_tDBInput_1.getInt(2);
							} else {
								throw new RuntimeException(
										"Null value in non-Nullable column");
							}
						...
						if (colQtyInRs_tDBInput_1 < 3) {
							...
							if (rs_tDBInput_1.getObject(3) != null) {
								row1.col3 = rs_tDBInput_1.getInt(3);
							} else {
								throw new RuntimeException(
										"Null value in non-Nullable column");
							}
						...
						if (colQtyInRs_tDBInput_1 < 4) {
							...
							if (rs_tDBInput_1.getObject(4) != null) {
								row1.col4 = rs_tDBInput_1.getInt(4);
							} else {
								throw new RuntimeException(
										"Null value in non-Nullable column");
							}
						...
						positionUtil_tFileOutputPositional_1.setValue_0(row1,
								sb_tFileOutputPositional_1,
	...
	public static void main(String[] args) {
		final B_DBTalendPruebaTabla1ToCSV B_DBTalendPruebaTabla1ToCSVClass = new B_DBTalendPruebaTabla1ToCSV();

		int exitCode = B_DBTalendPruebaTabla1ToCSVClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = B_DBTalendPruebaTabla1ToCSV.class
					.getClassLoader().getResourceAsStream(
							"local_project/b_dbtalendpruebatabla1tocsv_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = B_DBTalendPruebaTabla1ToCSV.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : B_DBTalendPruebaTabla1ToCSV");
		}
...
/************************************************************************************************
 * 44152 characters generated by Talend Open Studio for Data Integration on the
 * 21 de mayo de 2019 11:24:15 CEST
 ************************************************************************************************/
