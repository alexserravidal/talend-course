...
package local_project.a_dbconnectiontalendprueba_0_1;
...
/**
 * Job: A_DBConnectionTalendPrueba Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class A_DBConnectionTalendPrueba implements TalendJob {
	...
	private final String jobName = "A_DBConnectionTalendPrueba";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					A_DBConnectionTalendPrueba.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(A_DBConnectionTalendPrueba.this,
	...
	public static void main(String[] args) {
		final A_DBConnectionTalendPrueba A_DBConnectionTalendPruebaClass = new A_DBConnectionTalendPrueba();

		int exitCode = A_DBConnectionTalendPruebaClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = A_DBConnectionTalendPrueba.class
					.getClassLoader().getResourceAsStream(
							"local_project/a_dbconnectiontalendprueba_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = A_DBConnectionTalendPrueba.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : A_DBConnectionTalendPrueba");
		}
...
/************************************************************************************************
 * 26032 characters generated by Talend Open Studio for Data Integration on the
 * 21 de mayo de 2019 11:22:08 CEST
 ************************************************************************************************/
