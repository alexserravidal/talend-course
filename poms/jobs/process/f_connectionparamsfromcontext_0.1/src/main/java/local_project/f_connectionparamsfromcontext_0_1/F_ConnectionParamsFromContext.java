...
package local_project.f_connectionparamsfromcontext_0_1;
...
/**
 * Job: F_ConnectionParamsFromContext Purpose: <br>
 * Description: Establece una conexión con la BD "talend", pero en vez de coger los parámetros de configuration de Metadata los coge de Context <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class F_ConnectionParamsFromContext implements TalendJob {
	...
	private final String jobName = "F_ConnectionParamsFromContext";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					F_ConnectionParamsFromContext.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(F_ConnectionParamsFromContext.this,
	...
	public static class row1Struct implements
		...
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_F_ConnectionParamsFromContext = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_F_ConnectionParamsFromContext = new byte[0];
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LOCAL_PROJECT_F_ConnectionParamsFromContext) {
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String dbUser_tDBInput_1 = context.login;

				final String decryptedPassword_tDBInput_1 = context.password;

				String dbPwd_tDBInput_1 = decryptedPassword_tDBInput_1;

				String url_tDBInput_1 = "jdbc:mysql://" + context.host + ":"
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						strBuffer_tLogRow_1.append(String.valueOf(row1.col1));

						strBuffer_tLogRow_1.append("|");

						strBuffer_tLogRow_1.append(String.valueOf(row1.col2));

						strBuffer_tLogRow_1.append("|");

						strBuffer_tLogRow_1.append(String.valueOf(row1.col3));

						strBuffer_tLogRow_1.append("|");

						strBuffer_tLogRow_1.append(String.valueOf(row1.col4));
	...
	public static void main(String[] args) {
		final F_ConnectionParamsFromContext F_ConnectionParamsFromContextClass = new F_ConnectionParamsFromContext();

		int exitCode = F_ConnectionParamsFromContextClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = F_ConnectionParamsFromContext.class
					.getClassLoader().getResourceAsStream(
							"local_project/f_connectionparamsfromcontext_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = F_ConnectionParamsFromContext.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : F_ConnectionParamsFromContext");
		}
...
/************************************************************************************************
 * 37199 characters generated by Talend Open Studio for Data Integration on the
 * 21 de mayo de 2019 12:37:06 CEST
 ************************************************************************************************/
